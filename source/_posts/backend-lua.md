...
excerpt: Lua 语言基础、表、函数、模块、协程、OpenResty 场景和常见问题。
...
Lua 是轻量、可嵌入的脚本语言，常用于游戏脚本、配置扩展、嵌入式设备、`Nginx/OpenResty`、插件系统和业务规则脚本。
...
| 数组下标不对 | Lua 数组习惯从 `1` 开始 | 避免套用 `JS/PHP` 的 `0` 起始习惯 |
