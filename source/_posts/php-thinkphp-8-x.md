...
excerpt: ThinkPHP 8.x 新项目选型、PHP 版本要求、项目结构、部署和升级注意事项。
...
如果项目涉及秒杀、支付回调、库存扣减、优惠券领取、定时任务并发执行等场景，可以配合阅读：[ThinkPHP 8 高并发处理](/blog/posts/php-thinkphp8-high-concurrency/)。
