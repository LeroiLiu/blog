...
excerpt: ThinkPHP 8 在高并发场景下的库存扣减、幂等、Redis 锁、简单 SQL、事务、队列、限流和常见问题处理。
...
- [MySQL 慢查询常见问题](/blog/wiki/backend/database-mysql-slow-query/)
- [MySQL 索引](/blog/wiki/backend/database-mysql-indexes/)
