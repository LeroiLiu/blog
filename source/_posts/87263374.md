...
excerpt: Aras Innovator PLM 二次开发入门，整理环境搭建、IOM.dll 引用、连接登录、对象创建和查询操作。
...
![创建一个控制台程序示意图](/blog/images/blog/87263374/local-001.png)

### 1.2 项目引用中加入 IOM.dll文件，路径在这里 C:\\Program Files (x86)\\Aras\\Innovator\\Innovator\\Server\\bin

![项目引用中加入 IOM.dll文件示意图](/blog/images/blog/87263374/local-002.png)
...
![使用IomFactory创建连接登陆示意图](/blog/images/blog/87263374/local-003.png)
...
![创建一个新的innovator实例示意图](/blog/images/blog/87263374/local-004.png)
...
![用户查询示意图](/blog/images/blog/87263374/local-005.png)
...
![创建对象Document示意图](/blog/images/blog/87263374/local-006.png)
