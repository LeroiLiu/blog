...
excerpt: 1、引入PHPExcel类库： 2、创建一个PHPExcel对象： 3、设置文档的属性： 4、給Excel表格增加数据： 解析： setActiveSheetIndex(0) 表示选择当前Excel表的第一张表并为活动表。 setCellValue('A1', 'Hello') 表示在A1的位置添加上“Hello”这条数据。 5、重新工作表的名称： 解析：
...
![设置文档的属性示意图](/blog/images/blog/73743437/left-1779940735238-1.png)
...
![給Excel表格增加数据示意图](/blog/images/blog/73743437/left-1779940736970-2.png)
...
![重新工作表的名称示意图](/blog/images/blog/73743437/left-1779940738145-3.png)
...
![在Excel表中格式化添加时间示意图](/blog/images/blog/73743437/left-1779940739985-4.png)
...
![添加文字示意图](/blog/images/blog/73743437/left-1779940741567-5.png)
...
![打印：设置页眉和页脚，只有打印出来才能看见效果示意图](/blog/images/blog/73743437/left-1779940742902-6.png)
