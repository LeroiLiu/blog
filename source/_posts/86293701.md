...
excerpt: 对于Web应用的开发，如果你没用使用正确的工具，那开发过程可能会变得困难和痛苦。如果你之前开发过Java程序，我相信你肯定知道Jar文件(Jar是Java ARchive的缩写)。一个应用，包括所有的可执行、可访问的文件，都打包进了一个JAR文件里，使得部署过程十分简单。 PHAR (“Php ARchive”) 是PHP里类似于JAR的一种打包文件。如果你
...
![phar的认识与使用示意图](/blog/images/blog/86293701/local-001.jpg)
...
![我们的第一个 PHAR 文件示意图](/blog/images/blog/86293701/local-002.jpg)
...
![创建 PHAR 文件示意图](/blog/images/blog/86293701/local-003.jpg)

打开浏览器，将地址指向 `run.php`，你能看到下面的输出：

![创建 PHAR 文件示意图 2](/blog/images/blog/86293701/local-004.jpg)
