...
excerpt: Vue 2、Vue 3 不同版本、项目选型、迁移建议和常见问题入口。
...
| 页面 | 内容 |
| --- | --- |
| [Vue 2 常见问题](/blog/posts/frontend-vue-2/) | 响应式限制、`this`、生命周期、组件通信、Vuex |
| [Vue 3 常见问题](/blog/posts/frontend-vue-3/) | Composition API、`setup`、Pinia、Vite、TypeScript |
