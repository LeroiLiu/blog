...
| 模板 | 常见技术栈 | 适合场景 |
| --- | --- | --- |
| [vue-admin-template](/blog/wiki/frontend/frontend-vue-element-admin/) | Vue 2、Element UI、vue-router、Vuex、Webpack | 想要一个干净的 Vue 2 后台骨架 |
| [vue-element-admin](/blog/wiki/frontend/frontend-vue-element-admin/) | Vue 2、Element UI、权限路由、TagsView、国际化 | 需要完整后台示例和较多内置模块 |
| [mall-admin-web](/blog/wiki/frontend/frontend-mall-admin-web/) | Vue 2、Element UI、mall 后台接口 | 维护 mall 体系、电商后台、商品订单权限模块 |
| [Geeker Admin](/blog/wiki/frontend/frontend-geeker-admin/) | Vue 3、TypeScript、Vite、Pinia、Element Plus | 新项目或想用 Vue 3 技术栈 |
| [iView UI v4](/blog/wiki/frontend/frontend-iview-ui-v4/) | Vue 2、View UI、组件库 | 老 Vue 2 项目继续维护 iView/View UI |
| [iview-admin](/blog/wiki/frontend/frontend-iview-admin/) | Vue 2、iView/View UI、vue-router、Vuex | 历史 iView 后台项目维护 |
...
- [Geeker Admin](/blog/wiki/frontend/frontend-geeker-admin/)
- [Vite 使用文档](/blog/wiki/frontend/frontend-vite/)
- [TypeScript 使用文档](/blog/wiki/frontend/frontend-typescript/)
- [Element Plus](/blog/wiki/frontend/frontend-element-plus/)
...
- [vue-element-admin](/blog/wiki/frontend/frontend-vue-element-admin/)
- [mall-admin-web](/blog/wiki/frontend/frontend-mall-admin-web/)
- [iview-admin](/blog/wiki/frontend/frontend-iview-admin/)
- [iView UI v4](/blog/wiki/frontend/frontend-iview-ui-v4/)
