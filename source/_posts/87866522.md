...
excerpt: Sidecar设计模式正在收到越来越多的关注和采用。作为Service Mesh的重要要素，Sidecar模式对于构建高度高度可伸缩、有弹性、安全且可便于监控的微服务架构系统至关重要。而Service Mesh也已经被证明，正在改变企业IT的“游戏规则”，它降低了与微服务架构相关的复杂性，并提供了负载平衡、服务发现、流量管理、电路中断、遥测、故障注入等功能特
date: '2019-02-21 18:50:13'
cover: /blog/images/blog/87866522/local-001.png
tagline: 微服务架构中的 Sidecar 模式与 Service Mesh 基础
listing:
  priority: 100
categories:
  - 架构与云原生
...
![Sidecar模式如何工作示意图](/blog/images/blog/87866522/local-001.png)
