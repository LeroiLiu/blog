...
excerpt: In this article, we will look at using JWT to secure our Laravel APIs. JSON Web Token (JWT) is an open standard that allows two parties to securely send data and information as JSO
...
_数据库设计：_![备注：token的表示方法：Authorization:示意图](/blog/images/blog/84554490/local-001.png)
