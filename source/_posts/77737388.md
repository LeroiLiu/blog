...
excerpt: 这篇文章主要帮助大家理解 javascript 中的 with 关键字，学习 with 关键字的作用、作用域变化和常见注意点。
...
这篇文章主要帮助大家理解 javascript 中的 with 关键字，学习 with 关键字的作用和常见注意点。
...
**1、this关键字**
关于this关键字的文章google上面相当多，这里不再赘述，我们只需记住一点：this关键字始终指向调用函数的对象。在这里，foo函数中，this指向的就是obj对象。因此在`with(this)`语句块里面，可以直接通过x变量来访问obj的x属性。
**2、变量提升**
...
//20，obj.x已被修改为20
console.log(obj.y);
//undefined，obj不存在y属性，则为undefined
~~~
