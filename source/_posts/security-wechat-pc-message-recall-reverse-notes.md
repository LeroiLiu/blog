...
excerpt: 从 PC 微信 2.8.0.121 的内存搜索、写入断点、调用点定位和 DLL Hook 代码整理消息防撤回实现过程。
...
![PC 微信逆向示意图](/blog/images/security/wechat-pc-message-recall-reverse-notes/815293_FU27GHRDFWTFEAK.jpg)

我们看一下效果图，撤回的消息被我们看到了，相当于防（防止）撤回

![PC 微信逆向示意图 2](/blog/images/security/wechat-pc-message-recall-reverse-notes/815293_X53TUY8WE43NBMA.jpg)
...
![PC 微信逆向示意图 3](/blog/images/security/wechat-pc-message-recall-reverse-notes/815293_BUR55NXBW3VKUMJ.jpg)

用另一个微信号给在电脑登录的微信号随机发一条消息，勾选 **UTF-16 ** 选项，然后在CE中搜索 ** 消息内容**

![PC 微信逆向示意图 4](/blog/images/security/wechat-pc-message-recall-reverse-notes/815293_SFSQNEXV7Q7Y3FP.jpg)

撤回消息，看到一条xml消息，双击它添加到地址列表

![PC 微信逆向示意图 5](/blog/images/security/wechat-pc-message-recall-reverse-notes/815293_7QJUJMS7G7EU42Y.jpg)

打开OD，附加微信进程，用dd命令定位到上面的那个地址

![PC 微信逆向示意图 6](/blog/images/security/wechat-pc-message-recall-reverse-notes/815293_5J895PVS54ZW28E.jpg)
...
![PC 微信逆向示意图 7](/blog/images/security/wechat-pc-message-recall-reverse-notes/815293_7N28KHWFTHMMPQD.jpg)

在反汇编窗口中跟随这个call，点击这个call，按F2在该call下断点，按F9继续运行。再给在电脑登录那个微信号发一条消息并撤回，该call断下

![PC 微信逆向示意图 8](/blog/images/security/wechat-pc-message-recall-reverse-notes/815293_RQBJ7NZ9YNE23Y7.jpg)

说明，这个call就是我们要找的消息撤回的位置，而且它有我们想要的数据

![PC 微信逆向示意图 9](/blog/images/security/wechat-pc-message-recall-reverse-notes/815293_9YNHPYQ5YEPV3US.jpg)
