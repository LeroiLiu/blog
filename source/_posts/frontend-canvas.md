...
excerpt: JavaScript Canvas 基础绘制、高清屏适配、动画、事件坐标、图片导出、性能优化和常见问题整理。
...
- [Konva.js](/blog/posts/frontend-konva/)：适合图形交互、舞台、图层、节点、Transformer。
- [Fabric.js](/blog/posts/frontend-fabric/)：适合图片编辑、海报编辑、对象模型、SVG、序列化。
